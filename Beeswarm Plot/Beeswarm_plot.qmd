...
```{r}
data <- read_excel("Beeswarm data.xlsx") %>%
...
data %>%
    ...
    ggplot(aes(x=ACT_section,y=Score,color=Year)) +
    geom_quasirandom() +
    scale_color_manual(values=c("#003865", "#A6192E", "#FFC845")) +
    scale_y_continuous(n.breaks=8) +
    labs(x = "ACT section", y="Average score") +
