...
ui <- fluidPage(    
  ...
  mainPanel(
    ...
    h4("Violin Distribution Plot"),
    plotOutput("studentPlot"),
    h4("Density Distribution Plot"),
    plotOutput("retirementPlot"),
    h4("Histogram Distribution Plot"),
    plotOutput("homePlot"),
    h4("Boxplot Distribution Plot - Average Values"),
    plotOutput("avgWealthPlot"),
    h4("Boxplot Distribution Plot - Median Values"),
    plotOutput("medWealthPlot"),
    h4("Ridgeline Distribution Plot"),
