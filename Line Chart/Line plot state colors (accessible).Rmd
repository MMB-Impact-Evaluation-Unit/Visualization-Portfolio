...
data %>%
    ...
    scale_color_mncol() +
    scale_fill_mncol() +
    scale_linetype_manual(values=c("A" = 1,"B" = 1,"C" = 1,"D" = 1,"E" = 2,"F" = 3)) +
    scale_shape_manual(values = c("A" = 21,"B" = 21,"C" = 21,"D" = 21,"E" = 22,"F" = 23)) +
...
# save to PNG
ggsave(
    filename = "Line plot state colors.png",
...
data %>%
    ...
    geom_point(aes(shape=Group,fill=Group),color = "black", stroke = 0.8, size = 3) +
...
# save to PNG
ggsave(
    filename = "Line plot error bars state colors.png",
    width=6.5, # Maximum plot width should be 6.5 or 7
