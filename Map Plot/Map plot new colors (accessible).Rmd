...
```{r data}
county <- read_excel("Example map data.xlsx",sheet=1)
region <- read_excel("Example map data.xlsx",sheet=2)
```
...
# save to PNG
ggsave(
    filename = "County map plot new colors.png",
...
# save to PNG
ggsave(
    filename = "Region map plot new colors.png",
    width=5.5, # Maximum plot width should be 6.5 or 7
    height=7 * 10/16, # Scale this however you want. Current is 16:10
    units="in"
)
