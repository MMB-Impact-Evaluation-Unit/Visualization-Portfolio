---
title: "Correlation plot new colors (accessible)"
...
cor_melt %>%
    ...
    # specify fill color for each category
    scale_fill_manual(values=c("Very weak"="#78BE21","Weak"="#FDEC51","Middle"="#A4BCC2","Strong"="#404788","Very strong"="#003865")) +
...
# save to PNG
ggsave(
    filename = "Correlation plot new colors (accessible).png",
