...
selected_countries %>%
    ...
    # specifying different shapes is optional with this color palette
    #scale_shape_manual(values=c(21,22,23,24,25,21)) +
    scale_fill_manual(values=c(
        "France"="#003865","Germany"="#78BE21","Italy"="#008EAA","Spain"="#A4BCC2","Türkiye"="#404788","United Kingdom"="#FDEC51")) +
