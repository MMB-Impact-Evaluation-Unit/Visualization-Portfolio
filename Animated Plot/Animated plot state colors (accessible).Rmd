...
p <- earnFiltered %>%
    ...
    scale_color_manual("Age group",values=c("16 to 24 years"="#003865","25 to 34 years"="#78BE21","35 to 44 years"="#5D295F","45 to 54 years"="#008EAA","55 to 64 years"="#8D3F2B","65 years and over"="#0D5257"),breaks = age_levels,limits = age_levels) +
    # therefore, each category/group has a distinctive shape
    scale_shape_manual("Age group",values=c(21,22,23,24,25,22)) +
    scale_fill_manual("Age group",values=c("16 to 24 years"="#003865","25 to 34 years"="#78BE21","35 to 44 years"="#5D295F","45 to 54 years"="#008EAA","55 to 64 years"="#8D3F2B","65 years and over"="#0D5257"),breaks = age_levels,limits = age_levels) +
