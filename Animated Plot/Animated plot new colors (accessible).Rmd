...
p <- earnFiltered %>%
    ...
    scale_color_manual(values=c(
        "16 to 19 years"="#003865","20 to 24 years"="#78BE21","25 to 34 years"="#008EAA",
        "35 to 44 years"="#A4BCC2","55 to 64 years"="#404788","65 years and over"="#FDEC51")
        ,breaks = age_levels,limits = age_levels
    ) +
    # different point shapes are optional with this color palette
