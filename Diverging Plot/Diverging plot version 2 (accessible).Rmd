---
title: "Diverging plot version 2 (accessible)"
...
colors <- c(
    ...
    #,Agree =  "#6688a3" # 40% lighter than the dark blue
    ,Agree =  "#336084" # 20% lighter than the dark blue
    ,Neutral = "#D9D9D6"
    ,Disagree = "#ed9c4d" # 30% lighter than the orange
...
# save to PNG
ggsave(
    filename = "Diverging plot state colors.png",
